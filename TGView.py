...
global a1, a2
# global f1, f2
f1 = Figure(figsize=(4.7, 3.67), dpi=200, facecolor=(0.35, 0.35, 0.35))  # Figure(figsize=(7,6),dpi=100
f2 = Figure(figsize=(4.7, 3.67), dpi=200, facecolor=(0.35, 0.35, 0.35))  # Figure(figsize=(7,6),dpi=100
    ...
    def h2odataGrab():
        ...
        if var2.get() == 'radH2O':
            ...
            if h2odata_min < 0:
                ...
                a2.set_ylim(0 - 1, h2odata_max + 10)
            a2.plot(h2oxList, h2oyList, color='#2FA4FF', marker=markerStyle, picker=5, linewidth=1)
